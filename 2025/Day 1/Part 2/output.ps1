...
"Amount of times that the dial passed or ended on zero: $ZeroCounter"


$FullRotations = [math]::Floor($DialRotation / $DialRange.Length)
$DialTest = $DialRange[($DialLocation + 500) % 100]